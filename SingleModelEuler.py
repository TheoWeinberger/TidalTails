...
#program using the Euler method of integration to solve Newton's gravitational equations for one massive body
...
def Velocity_Step(r_pos, velocity, d_t):
    return velocity - d_t*Acceleration(r_pos)
...
#takes arguments i, x, y, scat, d_t, time and Acc_fac (factor to speed up movie output)
